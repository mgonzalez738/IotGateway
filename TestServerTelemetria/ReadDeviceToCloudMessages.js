...
const eventHubsCompatibleEndpoint = "sb://ihsuprodbyres035dednamespace.servicebus.windows.net/";

// Event Hub-compatible name
// az iot hub show --query properties.eventHubEndpoints.events.path --name {your IoT Hub name}
const eventHubsCompatiblePath = "iothub-ehub-monitoring-2971940-4fcc68444d";

// Primary key for the "service" policy to read messages
// az iot hub policy show --name service --query primaryKey --hub-name {your IoT Hub name}
const iotHubSasKey = "0JM0Wy2E4AgpDOtq8wmHis4IF8WUrEEEBsMcWQz35Oc=";
...
const connectionString = "Endpoint=sb://ihsuprodbyres035dednamespace.servicebus.windows.net/;SharedAccessKeyName=iothubowner;SharedAccessKey=aOFsWnGlHYPBUyO+J4QJtrq7zXITgnxlHuOewLiyTpU=;EntityPath=iothub-ehub-monitoring-2971940-4fcc68444d"
...
var printMessages = function (messages) {
  for (const message of messages) {
    ...
    console.log("Propiedades (dispositivo): ");
    console.log(JSON.stringify(message.properties));
    console.log("System properties (IoT Hub): ");
...
async function main() {
  console.log("");
    console.log("Telemetria - Recepcion mensajes en el Hub.");
    console.log("");
    console.log("");
